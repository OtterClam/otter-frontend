const German = {
  translation: {
    ...
    migrate: {
      ...
      migrateTo: 'Migriere von CLAM zu CLAM2',
      estimatedClamTwo: 'Erwartete CLAM2 ',
      yourClamTwoBalance: 'Ihr CLAM2 Bestand',
    },
    // src\views\Bond
    bonds: {
    ...
    stake: {
      ...
      connectWalletDescription: 'Verbinden Sie Ihre Wallet mit CLAM2-Tokens!',
      approvalInfo:
